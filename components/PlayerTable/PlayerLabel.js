...
export default function PlayerLabel({ player, draftedMap, setDraftedMap,
    pickNum, setPickNum, manualMode }) {
    return <tr
        ...
        onClick={() => !manualMode ? null : togglePlayerDrafted(player,
            draftedMap, setDraftedMap, pickNum, setPickNum)}
    >
        {
